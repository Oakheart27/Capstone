...
public class Registration
{
    ...
    public string LoadConnectionString()
    {
        ...
        {
            string filePath = Application.dataPath + "/Scripts/Tests/testdb.s3db";
        ...
        {
            string filePath = Application.persistentDataPath + "/testdb.s3db";
    ...
    public bool verifyInputs(string username, string password, IDbConnection dbconn)
    {
